...
- (UITabBarController *)contentTabBarController {
    if (!_contentTabBarController)
    {
        ...
        UINavigationController *fourContenViewController = [[UINavigationController alloc] initWithRootViewController:user];
        
        contentTabBarController.viewControllers = @[firstContentViewController, secondContentViewController, thirdContentViewController, fourContenViewController];
        ...
        fourContenViewController.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"个人中心" image:fourImg1 selectedImage:fourImg2];
        // 设置tabbar文字颜色
