//
//  MyAllCollectTableViewController.m
//  北信+
//
//  Created by #incloud on 16/11/4.
...
@interface MyAllCollectTableViewController () <UIWebViewDelegate>
...
- (void)loadNewData
{
    ...
    [bquery whereObjectKey:@"collect_questions" relatedTo:post];
...
- (void)anction:(UIButton *)button
{
    ...
    MyAllCollectDetailViewController *de = [[MyAllCollectDetailViewController alloc] init];
